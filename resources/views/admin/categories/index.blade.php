...
=======
    <header class="flex justify-between items-center mb-10">
        <div>
            ...
            <p class="text-slate-500 font-medium">Kelola kategori event untuk pemfiltran.</p>
        </div>
        <button
                ...
                <tbody class="divide-y border-t">
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-8 py-6 text-slate-600">
                            Kategori untuk acara musik dan konser
                        </td>
                        <td class="px-8 py-6">
                            <span class="px-3 py-1 bg-indigo-100 text-indigo-600 rounded-lg text-sm font-bold">5 Event</span>
                        </td>
                        <td class="px-8 py-6">
                            <div class="flex gap-2">
                                <button
...
=======
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-8 py-6">
                            <p class="font-black text-slate-800">Workshop & Seminar</p>
                        </td>
                        <td class="px-8 py-6 text-slate-600">
                            Acara pembelajaran dan sharing pengetahuan
                        </td>
                        <td class="px-8 py-6">
                            <span class="px-3 py-1 bg-indigo-100 text-indigo-600 rounded-lg text-sm font-bold">3 Event</span>
                        </td>
                        <td class="px-8 py-6">
                            <div class="flex gap-2">
                                <button
