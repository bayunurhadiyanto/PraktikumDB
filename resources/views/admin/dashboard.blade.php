            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t">
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-8 py-6">
<<<<<<< HEAD
                            <p class="font-bold uppercase tracking-wide text-sm">Abdul Karim</p>
                            <p class="text-xs text-slate-400">abdul@example.com</p>
=======
...
>>>>>>> 690d8aa (Selesai fitur CRUD Event sesuai Modul 5)
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-8 py-6">
<<<<<<< HEAD
                            <p class="font-bold uppercase tracking-wide text-sm">Andi Bopeng</p>
                            <p class="text-xs text-slate-400">andi123@example.com</p>
=======
...
>>>>>>> 690d8aa (Selesai fitur CRUD Event sesuai Modul 5)
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-8 py-6">
<<<<<<< HEAD
                            <p class="font-bold uppercase tracking-wide text-sm">Susi Julia</p>
                            <p class="text-xs text-slate-400">juli@example.com</p>
=======
